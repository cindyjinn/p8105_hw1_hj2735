...
```
The scatterplot above shows temperature across time, with points colored by humidity. As we move from Jan 01 to Jan 15, the temperature tend to rise, and humidity tend to rise as well. The humidity tend to be highest when temperature is between 40F to 50F, and Jan 10 to Jan 15.
